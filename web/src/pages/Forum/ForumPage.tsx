    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm">Ask questions, share knowledge with 1 lakh+ farmers</p>
        </div>
        <button
        ...
        <div className="space-y-3">
          {data.content.map((post: any) => (
            <Link key={post.id} to={`/forum/${post.id}`}
              ...
              <div className="flex flex-col items-center gap-1 text-xs text-gray-500 flex-shrink-0 w-12 text-center">
