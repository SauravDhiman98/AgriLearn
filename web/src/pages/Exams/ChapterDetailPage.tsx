...
function PdfViewer({ url, title }: { url: string; title: string }) {
  ...
  return (
    ...
    >
      {/* Transparent overlay blocks right-click save on the PDF */}
